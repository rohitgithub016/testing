...
const OnboardingStep = ({
  ...
  return (
    <Flex vertical className="onboarding-page" style={{height: `calc(100vh - ${height}px)`}}>
      <Flex
        vertical
        style={{ flexGrow: 1 }}
        gap={48}
        ...
        <Flex gap={48} vertical>
          <Flex gap={48} vertical>
            ...
            <Flex className="onboarding-txt-container" vertical gap={12}>
              ...
              <Typography.Paragraph className="txt-center large-para-regular onboarding-step-description">
      ...
      <Flex id="onboarding-btn-container" ref={ref}>
        <Flex
